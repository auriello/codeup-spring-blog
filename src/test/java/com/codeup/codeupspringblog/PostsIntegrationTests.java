...
public class PostsIntegrationTests {
    ...
    public void testCreatePosts() throws Exception {
        ...
        this.mvc.perform(
                        post("/posts/create").with(csrf())
                                ...
                                .param("title", "test")
                                .param("body", "testing the creation of post"))
    ...
    public void testEditPost() throws Exception {
        ...
        // Makes a GET request to /postss/{id} and expect a redirection to the Ad show page
        this.mvc.perform(get("/posts/" + existingPost.getId()))
                .andExpect(status().isOk())
                // Test the dynamic content of the page
    ...
    public void testDeletePost() throws Exception {
        ...
        this.mvc.perform(
                post("/posts/create").with(csrf())
                      .session((MockHttpSession) httpSession)
                        .param("title", "deleted title")
                        .param("body", "deleted body"))
                .andExpect(status().is3xxRedirection());

        Post existingPost = postsDao.findByTitle("deleted title");
